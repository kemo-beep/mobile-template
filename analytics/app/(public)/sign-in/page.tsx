...
export default function SignInPage() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    setError(null);
    const callbackURL =
      typeof window !== "undefined" ? `${window.location.origin}/analytics` : "/analytics";
  ...
  return (
    <div className="mx-auto flex w-full max-w-md flex-col justify-center gap-6 px-4 py-16">
      <div className="space-y-2">
        <h1 className="text-2xl font-semibold">Developer sign in</h1>
        <p className="text-sm text-muted-foreground">
          Use your existing backend account to access analytics.
        </p>
      </div>
